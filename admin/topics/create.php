    ...
    <div class="row">
        ...
        <div class="posts col-9">
            <div class="button row">
                <a href="create.php" class="col-2 btn-success">Создать Категорию</a>
                <span class="col-1"></span>
                <a href="index.php" class="col-2 btn-warning">Управлять категориями</a>
            </div>
            ...
            <div class="row add-post">
                <form action="create.php" method="post">
                    ...
                    <div class="col">
                        <button name="btn-topic-create" class="btn btn-primary" type="submit">Создать категорию</button>
                    </div>
                </form>
            </div>
        </div>
