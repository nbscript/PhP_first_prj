    ...
    <div class="row">
        ...
        <div class="posts col-9">
            <div class="button row">
                ...
                <a href="index.php" class="col-2 btn-warning">Изменить</a>
            </div>
            <div class="row title-table">
                <h2>Управление Записями</h2>
                <div class="col-1">ID</div>
                <div class="col-5">Название статьи</div>
                <div class="col-2">Автор</div>
                <div class="col-2">Изменение</div>
            </div>
            <?php foreach ($postAuthors as $key => $post): ?>
            <div class="row post">
                ...
                <?php if ($post['status']): ?>
                <div class="status col-2"><a href="">hide</a></div>
                <?php else: ?>
